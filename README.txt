...
S1_WaterLevels_1995_2005_annual.csv
  ...
  - Columns: Year, Identifier, GeoType, Latitude, Longitude, WaterLevel, 
             DepthCategory
  - Corresponds to Appendix A, Table A.1
...
S2_Buffer_GW_Deltas.csv
  ...
  - Corresponds to Appendix A, Table A.4
...
S4_CHANGE DETECTION.csv
  ...
  - Contributors to Net Change per Class
  - From-To transition matrices
  - Removed from Appendix C for brevity

S5_A_Spearman Correlation_Matrix.csv
  - Complete Spearman correlation results (all predictors)
  - Truncated to top 20 in Appendix D (Tables D.2)

S7_Buffer_GW_ZonalStats_AllYears.csv
  - Buffer-level (500m) zonal extraction results
  - Output from R Script 4.5D

S8_Ward_GW_Stats_allYears.csv
  - Ward-level municipal zonal extraction results
  - Output from R Script 4.5E
...
Shipalana, M.S. (2026). Supplementary Data for:  The impact of land use and land cover change on groundwater in Greater Giyani Local Municipality, South Africa.. Zenodo. https://doi.org/10.5281/zenodo.18474680
